...
@Component({
  selector: 'rms-administration-create-profiles',
  templateUrl: './administration-create-profiles.component.html',
  styleUrls: ['./administration-create-profiles.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class AdministrationCreateProfilesComponent implements OnInit {
  ...
  private _createForm() {
    this.userInfoForm = this.fb.group({
      profileName: [this.passedData && this.itemData.profileName ? this.itemData.profileName : '', [
        Validators.required,
  ...
  get _profileName() {
    return this.userInfoForm.get('profileName')
  }
  ...
  onPressProfilesCancel() {
    this.location.back();
  }
  onPressRolesCancel() {
    this.location.back();
  }
  onPressDashboardCancel() {
    this.location.back();
  }

  onPressCategoryCancel() {
    this.location.back();
  }
  onPressReportsCancel() {
    this.location.back();
  }
  
  onPressDomainsCancel() {
    this.location.back();
  }  
  onPressQueueCancel() {
    this.location.back();
  ...
  onPressSave() {
    if (this.userInfoForm.invalid) {
      ...
      const userInfo = {
        firstName: this.userInfoForm.value.profileName
      }
